...
INPUT_IMAGE = "Chapter_4_1 _page-0030.jpg"

# 2. OpenAI Configuration (1_bounding_box_choice)
OPENAI_API_KEY = os.environ.get("OPENAI_API_KEY")  # Retrieve key from OS environment variable
OPENAI_MODEL = "gpt-4o"
...
if os.path.exists(_prompt_path):
    ...
    OPENAI_PROMPT = (
        ...
        "the bounding boxes should be 5 at most."
    )
...
SAM_CHECKPOINT_URL = "https://github.com/ultralytics/assets/releases/download/v8.2.0/mobile_sam.pt"
