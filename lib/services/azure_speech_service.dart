...
class AzureSpeechService {
  ...
  final List<String> phraseList = ["Flutter", "setState", "gRPC", "Widget", "StatefulWidget", "StatelessWidget"];
  ...
  void _sendSpeechConfig() {
    ...
    final header = "path: speech.config\r\nContent-Type: application/json; charset=utf-8\r\n\r\n";
      ...
      try {
        ...
        if (parts.length > 1) {
          ...
          if (event.contains("speech.hypothesis")) {
            ...
            if (data['RecognitionStatus'] == 'Success' && data['DisplayText'] != null) {
